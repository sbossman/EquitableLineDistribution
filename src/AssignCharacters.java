...
public class AssignCharacters{
			 ...
			 if(!noContra) {
				 ...
				 if(roles.get(roles.size() - 1).canAdd(charRemove)) {
					 ...
					 for(int i = 0; i < roles.size(); i++) {
						 ...
						 System.out.println(roles.get(mostContradictoryRole()).getCharacters().get(charRemoveI));
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		AssignCharacters r = new AssignCharacters("C:\\Users\\summe\\eclipse-workspace\\Shakespeare\\src\\txt\\Ham4-5.txt", 5);
